...
![iOS Identifier Config](/img/v5/docs/guides/deep-links/ios-config.png)
...
![Xcode Associated Domain](/img/v5/docs/guides/deep-links/xcode-associated-domain.png)
...
![Keytool output](/img/v5/docs/guides/deep-links/keystore-sha256.png)
...
![Android Identifier Config](/img/v5/docs/guides/deep-links/android-config.png)
