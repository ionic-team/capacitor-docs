...
![Android Clean and Build](/img/v5/docs/android/clean-rebuild.png)
...
![Android Invalidate Caches](/img/v5/docs/android/invalidate-caches.png)
...
![Sync Gradle](/img/v5/docs/android/sync-gradle.png)
...
![Android APK Failed](/img/v5/docs/android/apk-failed.png)
...
![JDK Path in Android Studio](/img/v5/docs/android/jdk-path.png)
