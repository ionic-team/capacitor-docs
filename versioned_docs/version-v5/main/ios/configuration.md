...
![Xcode info editor](/img/v5/docs/ios/xcode-info-editor.png)
...
![Xcode Capabilities](/img/v5/docs/ios/xcode-capabilities.png)
...
![Xcode Target](/img/v5/docs/ios/xcode-target.png)
