...
![Locations](/img/v5/docs/ios/location-prefs.png)
...
![Deleting Derived Data](/img/v5/docs/ios/deleting-derived-data.png)
...
![Xcode indexing](/img/v5/docs/ios/indexing.png)
