...
<img src={require('@site/static/img/v3/docs/pwa-elements.png').default} style={{ height: '200px' }} />
...
></script>
<script nomodule src="https://unpkg.com/@ionic/pwa-elements@2/dist/ionicpwaelements/ionicpwaelements.js"></script>
```
