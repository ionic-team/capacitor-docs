...
![Enabling Push Notifications Capabilities](/img/v3/docs/ios/enable-push-capabilities.png)
...
![Disable Push Notifications](/img/v3/docs/ios/disable-push-plugin.png)
