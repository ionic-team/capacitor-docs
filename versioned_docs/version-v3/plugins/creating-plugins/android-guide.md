...
To get started, first generate a plugin as shown in the [Getting Started](/docs/v3/plugins) section of the Plugin guide.
...
> It is also possible to trigger global events on `window`. See the docs for [`triggerJSEvent`](/docs/v3/core-apis/android#triggerjsevent).
