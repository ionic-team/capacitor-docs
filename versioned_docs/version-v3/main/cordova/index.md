...
[Learn more about the Capacitor CLI &#8250;](/docs/v3/cli)

## Start the Migration

Learn more about the [migration process](/docs/v3/cordova/migration-strategy) or [get started migrating](/docs/v3/cordova/migrating-from-cordova-to-capacitor) right away.
