...
Once configured, the [`getLaunchUrl()` method in the App API](/docs/v3/apis/app#method-getLaunchUrl-0) will provide any URL the app was launched with, and the [`'appUrlOpen'` event](/docs/v3/apis/app#method-addListener-1) will fire any time the app receives a new App Link deeplink.
