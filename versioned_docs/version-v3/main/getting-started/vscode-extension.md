...
![Video of adding Capacitor](../../../../static/img/docs/getting-started/integrate-capacitor.gif)
...
![Capacitor Native Configuration Example Image](../../../../static/img/docs/getting-started/capacitor-vscode-config.gif)
...
![Capacitor Debugging Example Image](../../../../static/img/docs/getting-started/ionic-vs-code-debugging.jpg)
