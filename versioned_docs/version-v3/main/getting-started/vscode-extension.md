...
![Video of adding Capacitor](/img/v3/docs/getting-started/integrate-capacitor.gif)
...
![Capacitor Native Configuration Example Image](/img/v3/docs/getting-started/capacitor-vscode-config.gif)
...
![Capacitor Debugging Example Image](/img/v3/docs/getting-started/ionic-vs-code-debugging.jpg)
