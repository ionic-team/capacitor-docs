...
![Locations](/img/v3/docs/ios/location-prefs.png)
...
![Deleting Derived Data](/img/v3/docs/ios/deleting-derived-data.png)
...
![Xcode indexing](/img/v3/docs/ios/indexing.png)
...
We recommend using Homebrew to installl CocoaPods.
