...
iOS 12+ is supported. Xcode 12+ is required (see [Environment Setup](/docs/v3/getting-started/environment-setup#ios-development)). Capacitor uses [WKWebView](https://developer.apple.com/documentation/webkit/wkwebview), not the deprecated [UIWebView](https://developer.apple.com/documentation/uikit/uiwebview).
...
If you encountered any issues while getting started, you can consult the [iOS Troubleshooting Guide](/docs/v3/ios/troubleshooting). Feel free to [open a discussion](https://github.com/ionic-team/capacitor/discussions/) if you need help.
...
[Configuring and setting permissions for iOS &#8250;](/docs/v3/ios/configuration)

[Building Native Plugins for iOS &#8250;](/docs/v3/plugins)
