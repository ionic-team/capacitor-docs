...
To start, consult the official Apple documentation on [Submitting Apps to the App Store](https://developer.apple.com/app-store/submissions/). [See here](/docs/v3/guides/splash-screens-and-icons) for details on generating splash screens and icons for your app.
...
Interested? Check out this [brief guide](/docs/v3/guides/deploying-updates) on how it works and how you can use it with Capacitor today, or view the official [Appflow Documentation](https://ionicframework.com/docs/v3/appflow/).
