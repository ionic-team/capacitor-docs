...
![Xcode info editor](/img/v3/docs/ios/xcode-info-editor.png)
...
![Xcode Capabilities](/img/v3/docs/ios/xcode-capabilities.png)
...
![Xcode Target](/img/v3/docs/ios/xcode-target.png)
