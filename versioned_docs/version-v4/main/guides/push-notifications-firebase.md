...
![Add new Android Application in Firebase Console](/img/v4/docs/guides/firebase-push-notifications/add-android-app.png)
...
![Google Services JSON Location for Android](/img/v4/docs/guides/firebase-push-notifications/google-services-location-android.png)
...
![Google Service Info Plist Location for iOS](/img/v4/docs/guides/firebase-push-notifications/google-plist-location-ios.png)
...
![Podfile Location iOS](/img/v4/docs/guides/firebase-push-notifications/podfile-location-ios.png)
...
![Change Push Target Firebase](/img/v4/docs/guides/firebase-push-notifications/change-push-target-firebase.png)
...
![Push Test Android](/img/v4/docs/guides/firebase-push-notifications/push-test-android.png)

![Push Test iOS](/img/v4/docs/guides/firebase-push-notifications/push-test-ios.png)
