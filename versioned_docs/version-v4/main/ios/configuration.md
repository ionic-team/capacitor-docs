...
![Xcode info editor](/img/v4/docs/ios/xcode-info-editor.png)
...
![Xcode Capabilities](/img/v4/docs/ios/xcode-capabilities.png)
...
![Xcode Target](/img/v4/docs/ios/xcode-target.png)
