...
![UIDesignRequiresCompatibility plist entry](/img/ipados-controls-overlap.png)

To fix this add the following entry to your `Info.plist`:
`UIDesignRequiresCompatibility = YES`:

![UIDesignRequiresCompatibility plist entry](/img/ipados-controls-plist.png)

This should prevent the controls from overlapping:
![UIDesignRequiresCompatibility plist entry](/img/ipados-controls-fixed.png)
