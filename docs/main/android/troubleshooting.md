...
![Android Clean and Build](../../../static/img/docs/android/clean-rebuild.png)
...
![Android Invalidate Caches](../../../static/img/docs/android/invalidate-caches.png)
...
![Sync Gradle](../../../static/img/docs/android/sync-gradle.png)
...
![Android APK Failed](../../../static/img/docs/android/apk-failed.png)
