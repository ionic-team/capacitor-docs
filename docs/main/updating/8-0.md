...
In brief, margins handling has been deprecated in favor of using `env` / CSS variables for halding edge to edge.  Read [here](https://capacitorjs.com/docs/apis/system-bars#android-note) for more information and details on how to implement in your application.
