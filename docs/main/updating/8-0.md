...
`android.adjustMarginsForEdgeToEdge` is deprecated in favor of our new [System Bars](https://capacitorjs.com/docs/apis/system-bars) core plugin, which will handle edge to edge issues in modern Android.

In brief, margins handling has been deprecated in favor of using `env` / CSS variables for handling edge to edge.  Read [here](https://capacitorjs.com/docs/apis/system-bars#android-note) for more information and details on how to implement in your application.
